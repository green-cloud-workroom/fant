...
export const DEFAULT_SYSTEM_VALUES = {
  ...
  packsPerBox: 20,
  packsPerPlateCat: null,
  packsPerPlateDog: null,
...
export const SYSTEM_VALUE_FIELDS = [
  ...
  {
    key: 'packsPerPlateCat',
    label: '고양이 판당 팩수',
    desc: '제품 입고 시 판 1개당 팩 수 (고양이 생식). 판수 → 팩 환산에 사용.',
    type: 'integer',
    unit: '팩/판',
  },
  {
    key: 'packsPerPlateDog',
    label: '강아지 판당 팩수',
    desc: '제품 입고 시 판 1개당 팩 수 (강아지 생식). 판수 → 팩 환산에 사용.',
    type: 'integer',
    unit: '팩/판',
  },
  {
