import{b as e,d as t,g as n,s as r,u as i,y as a}from"./index.esm-rHmxwfvm.js";import{n as o}from"./firebase-qGjqjNvO.js";import{G as s,L as c,S as l,a as u,c as d,d as f,f as p,i as m,m as h,n as g,o as _,r as ee,s as v,u as y}from"./index-lv3jHCmD.js";import{n as b}from"./activityLogs-CgS1ycsl.js";import{t as x}from"./sortable-Dh9BCo_X.js";import{t as S}from"./readCommand-CFV9Wp6c.js";import{t as te}from"./pageRefresh-Dkf20J4p.js";import{t as C}from"./commandBatch-BvwieUXT.js";var w=h(`equipment`);async function T(e,t=[`admin`,`office`]){let n=l();try{return await S(w,t=>(t.isCurrent=()=>!n||n.isCurrent(),e(t)),{roles:t})}catch(e){console.error(`[설비 저장]`,e),alert(e.message)}}var E=`__all__`,D=[],O=[],k=E,A=null,j=!1,M=!1,N=[];async function P(e={}){let t=document.getElementById(`mainContent`);t.innerHTML=`<div style="padding:24px;"><p>설비 부품 로딩 중...</p></div>`,await F(e),document.getElementById(`mainContent`)===t&&R()}async function ne(e={getDocs:r}){return(await e.getDocs(t(a(o,`equipments`),i(`sortOrder`)))).docs.map(e=>({id:e.id,...e.data()}))}async function F({force:e=!1}={}){let t=document.getElementById(`mainContent`),n=await w.load(e=>De(e),{force:e,onChange:te(w,P)});!n||document.getElementById(`mainContent`)!==t||(D=n.equipment,O=n.parts,we=n.staff)}function I(){return s===`admin`||s===`office`}function L(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function R(){let e=document.getElementById(`mainContent`);e.innerHTML=`
