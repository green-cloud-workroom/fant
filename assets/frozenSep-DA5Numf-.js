import{a as e,b as t,d as n,s as r,u as i,y as a}from"./index.esm-rHmxwfvm.js";import{n as o}from"./firebase-qGjqjNvO.js";import{n as s}from"./modalManager-Z4b2ihO9.js";import{I as c,W as l,h as u}from"./index-BvUufXtY.js";import"./activityLogs-CtU4U8Oc.js";import{t as d}from"./closingGuard-C7IU8dK_.js";import{t as f}from"./sortable-B9aQZmIg.js";import{t as p}from"./pageResources-DBecWn5C.js";import{t as m}from"./pageRefresh-D_VW7uvN.js";import{t as h}from"./pageCommand-DOC7oE71.js";import{t as g}from"./commandWrites-CkkiGB36.js";import{n as _,t as v}from"./recipe-cphQcRpb.js";import{t as y}from"./pageStaff-CdJTpDb_.js";var b=[],x=1e-6;async function S({force:e=!1}={}){let n=document.getElementById(`mainContent`);n.innerHTML=`<p style="padding:24px">동결 분리작업 로딩 중...</p>`;let r=await Q.load(async e=>{let[n,r,i,a,s]=await Promise.all([v(e),C(e),w(e),y(e),e.getDoc(t(o,`settings`,`frozenSepProductOrder`))]);return{recipes:n,stocks:r,logs:i,staff:a,order:s.exists()&&s.data().order||[]}},{force:e,onChange:m(Q,S)});!r||!n.isConnected||(b=r.recipes,Y=r.staff,R=r.order,V(r.stocks,r.logs))}async function C(t={getDocs:r,getDoc:e}){let s=n(a(o,`frozenSeparation`),i(`date`,`desc`));return(await t.getDocs(s)).docs.map(e=>({id:e.id,...e.data()})).filter(e=>!e.closed)}async function w(t={getDocs:r,getDoc:e}){let s=n(a(o,`frozenSeparationLogs`),i(`timestamp`,`desc`));return(await t.getDocs(s)).docs.map(e=>({id:e.id,...e.data()}))}function T(e){return Math.round((Number(e)||0)*1e6)/1e6}function E(e){return T(e).toLocaleString(`ko-KR`,{maximumFractionDigits:3})}function D(e=`m_qty`){let t=Number(document.getElementById(e).value);return Number.isFinite(t)?t:NaN}function O(){return l===`admin`||l===`office`}function k(e){return e===`notSeparated`?`분리X`:e===`separated`?`분리O`:`소분X`}function A(e){return e===`notSeparated`?`tag-cat`:e===`separated`?`tag-raw`:`tag-freezeDry`}function j(e){let t=Number(e.qty||0);switch(e.type){case`incoming`:return[{stockType:e.toStockType,delta:t}];case`separate`:return[{stockType:e.fromStockType,delta:-t},{stockType:e.toStockType,delta:t}];case`out`:return[{stockType:e.fromStockType,delta:-t}];case`adjust`:return[{stockType:e.fromStockType,delta:t}];case`delete`:return[{stockType:e.fromStockType,delta:t}];default:return[]}}function M(e,t){let n={};e.forEach(e=>{let t=`${e.productName}|${e.stockType}`;n[t]=T((n[t]||0)+Number(e.remaining||0))});let r={};for(let e of t){let t=j(e),i={};t.forEach(t=>{if(!t.stockType)return;let r=`${e.productName}|${t.stockType}`;i[t.stockType]=T(n[r]||0),n[r]=T((n[r]||0)-t.delta)}),r[e.id]=i}return r}function N(e){return{incoming:`입고`,separate:`분리`,out:`출고`,adjust:`조정`,delete:`삭제`}[e]||e}function P(e){return{incoming:`#2d7a3a`,separate:`#1f6fb2`,out:`#b97a1f`,adjust:`#8a5fbf`,delete:`#e53e3e`}[e]||`#555`}var F={notSeparated:{bar:`#EF9F27`,bg:`#fdf3e0`,text:`#b97a1f`},separated:{bar:`#1D9E75`,bg:`#e8f5ea`,text:`#2d7a3a`},noSplit:{bar:`#378ADD`,bg:`#e8f0fc`,text:`#2d4a8a`}},I=new Set,L=`daily`,R=[];function z(e){return[...e].sort((e,t)=>{let n=R.indexOf(e),r=R.indexOf(t);return n!==-1&&r!==-1?n-r:n===-1?r===-1?e.localeCompare(t,`ko`):1:-1})}function B(e,t){let n={};e.forEach(e=>{let t=`${e.productName}|${e.stockType}`;n[t]=T((n[t]||0)+Number(e.remaining||0))});let r=[...new Set(t.map(e=>e.date).filter(Boolean))].sort().reverse(),i=c(),a=r.includes(i)?r:[i,...r.filter(e=>e<i)],o=[...t].filter(e=>e.date).sort((e,t)=>t.date.localeCompare(e.date)),s=0,l={},u={};for(let e of a){for(;s<o.length&&o[s].date>e;){let e=o[s];j(e).forEach(t=>{if(!t.stockType)return;let r=`${e.productName}|${t.stockType}`;n[r]=T((n[r]||0)-t.delta)}),s++}l[e]={...n},u[e]=[...new Set(t.filter(t=>t.date===e).map(e=>e.staffName).filter(Boolean))].join(`, `)}return{dates:a,snapshots:l,staffByDate:u}}function V(e,n=[]){let r=document.getElementById(`mainContent`),i=O(),a=M(e,n),s=z([...new Set([...e.map(e=>e.productName),...n.map(e=>e.productName).filter(Boolean)])]);r.innerHTML=`
    <div class="page-wrap">
  ...
  `}async function W(e){return h(Q,async n=>{let{writeBatch:r,recordActivity:i}=g(n);if(!O()){alert(`삭제 권한이 없습니다.`);return}if(await d(e.date,n))return;let s=Number(e.initialQty||0),l=Number(e.remaining||0);if(l<=0){alert(`삭제할 남은 수량이 없습니다.`);return}if(Math.abs(s-l)>x){alert(`이미 일부 사용된 항목은 바로 삭제할 수 없습니다.
관련 출고/분리 작업을 먼저 되돌리거나 수동 조정을 사용해주세요.`);return}let f=window.prompt(`삭제 담당자 이름을 입력해주세요.`);if(!f||!f.trim())return;let p=k(e.stockType);if(!await u({title:`동결 분리작업 삭제`,message:`${e.productName} / ${p} / ${E(l)}개 항목을 삭제합니다.\n잘못 입력한 항목일 때만 진행해주세요.`,confirmText:`삭제`,cancelText:`취소`,danger:!0}))return;let m=r(o),h=t(o,`frozenSeparation`,e.id),_=t(a(o,`frozenSeparationLogs`)),v=new Date,y=f.trim();m.update(h,{remaining:0,closed:!0,status:`deleted`,deletedAt:v,deletedBy:y,updatedAt:v}),m.set(_,{date:c(),timestamp:v,type:`delete`,productName:e.productName,fromStockType:e.stockType,qty:-l,staffName:y,note:`wrong input delete`,sourceStockId:e.id}),await m.commit(),await i({action:`frozenSep`,subAction:`delete`,date:c(),staff:y,message:`동결 분리작업 삭제 — ${e.productName} ${E(l)}개 (${p}) / 담당: ${y}`,details:{frozenSeparationId:e.id,productName:e.productName,qty:l,stockType:e.stockType,note:e.note||null}});let[b,S]=await Promise.all([C(),w()]);n.isCurrent()&&(V(b,S),alert(`삭제 완료!`))},{roles:[`admin`,`office`]})}function G(e){Z(`
  ...
  `),document.getElementById(`btnSaveSeparate`).addEventListener(`click`,async()=>h(Q,async e=>{let{addDoc:r,updateDoc:i,recordActivity:s}=g(e),c=document.getElementById(`m_product`).value,l=D(),u=document.getElementById(`m_date`).value,f=document.getElementById(`m_staff`).value;if(!c||!Number.isFinite(l)||l<=0||!u){alert(`제품, 수량, 날짜는 필수입니다.`);return}if(!f){alert(`담당자는 필수입니다.`);return}if(await d(u,e))return;let p=n.filter(e=>e.productName===c).sort((e,t)=>e.date.localeCompare(t.date)),m=p.reduce((e,t)=>e+Number(t.remaining||0),0);if(l-m>x){alert(`분리X 재고가 부족합니다. (현재: ${E(m)}개)`);return}let h=l;for(let e of p){if(h<=0)break;let n=Number(e.remaining||0),r=Math.min(n,h),a=T(n-r);await i(t(o,`frozenSeparation`,e.id),{remaining:a,closed:a<=x,updatedAt:new Date}),h=T(h-r)}let _=await r(a(o,`frozenSeparation`),{date:u,productName:c,stockType:`separated`,initialQty:l,remaining:l,staffName:f,note:``,closed:!1,createdAt:new Date,updatedAt:new Date});if(await r(a(o,`frozenSeparationLogs`),{date:u,timestamp:new Date,type:`separate`,productName:c,fromStockType:`notSeparated`,toStockType:`separated`,qty:l,staffName:f}),await s({action:`frozenSep`,subAction:`separate`,date:u,staff:f,message:`분리 작업 — ${c} ${E(l)}개 (분리X → 분리O) / 담당: ${f}`,details:{newSeparatedId:_.id,productName:c,qty:l,fromStockType:`notSeparated`,toStockType:`separated`}}),!e.isCurrent())return;closeModal();let[v,y]=await Promise.all([C(),w()]);e.isCurrent()&&(V(v,y),alert(`분리 작업 완료!`))},{roles:[`admin`,`office`,`production`]}))}function q(e){let n=e.filter(e=>e.stockType===`separated`||e.stockType===`noSplit`);Z(`
  ...
  `),window.updateOutType=function(){let e=document.getElementById(`m_product`).value,t=document.getElementById(`m_outGuide`);if(!e){t.innerHTML=`제품을 선택하면 자동으로 결정됩니다.`,t.style.color=`#555`;return}let r=b.find(t=>t.displayName===e);if(!r){t.innerHTML=`⚠️ 레시피를 찾을 수 없습니다.`,t.style.color=`#c0392b`;return}let i=r.requiresSeparation?`separated`:`noSplit`,a=r.requiresSeparation?`분리O`:`소분X`,o=r.requiresSeparation?`#2d7a3a`:`#2d4a8a`,s=n.filter(t=>t.productName===e&&t.stockType===i).reduce((e,t)=>e+Number(t.remaining||0),0);s<=x?(t.innerHTML=`⚠️ <b style="color:${o};">${a}</b> 재고 없음 — ${r.requiresSeparation?`먼저 분리 작업이 필요합니다.`:`소분X 재고가 없습니다.`}`,t.style.color=`#c0392b`):(t.innerHTML=`📌 <b style="color:${o};">${a}</b> 재고에서 출고됩니다 (현재 ${E(s)}개 보유)`,t.style.color=`#555`)},updateOutType(),document.getElementById(`btnSaveOut`).addEventListener(`click`,async()=>h(Q,async e=>{let{addDoc:r,updateDoc:i,recordActivity:s}=g(e),c=document.getElementById(`m_product`).value,l=D(),u=document.getElementById(`m_date`).value,f=document.getElementById(`m_staff`).value;if(!c||!Number.isFinite(l)||l<=0||!u){alert(`제품, 수량, 날짜는 필수입니다.`);return}if(!f){alert(`담당자는 필수입니다.`);return}if(await d(u,e))return;let p=b.find(e=>e.displayName===c);if(!p){alert(`레시피를 찾을 수 없습니다. 레시피 관리에서 등록 여부를 확인해주세요.`);return}let m=p.requiresSeparation?`separated`:`noSplit`,h=p.requiresSeparation?`분리O`:`소분X`,_=n.filter(e=>e.productName===c&&e.stockType===m).sort((e,t)=>e.date.localeCompare(t.date)),v=_.reduce((e,t)=>e+Number(t.remaining||0),0);if(l-v>x){let e=p.requiresSeparation?`

분리 작업을 먼저 진행해주세요.`:``;alert(`${h} 재고가 부족합니다. (현재: ${E(v)}개)${e}`);return}let y=l;for(let e of _){if(y<=0)break;let n=Number(e.remaining||0),r=Math.min(n,y),a=T(n-r);await i(t(o,`frozenSeparation`,e.id),{remaining:a,closed:a<=x,updatedAt:new Date}),y=T(y-r)}if(await r(a(o,`frozenSeparationLogs`),{date:u,timestamp:new Date,type:`out`,productName:c,fromStockType:m,qty:l,staffName:f}),await s({action:`frozenSep`,subAction:`out`,date:u,staff:f,message:`분리작업 출고 — ${c} -${E(l)}개 (${h}) / 담당: ${f}`,details:{productName:c,qty:l,fromStockType:m,autoDecided:!0}}),!e.isCurrent())return;closeModal();let[S,O]=await Promise.all([C(),w()]);e.isCurrent()&&(V(S,O),alert(`출고 완료!`))},{roles:[`admin`,`office`,`production`]}))}function J(e){Z(`
  ...
  `),document.getElementById(`btnSaveAdjust`).addEventListener(`click`,async()=>h(Q,async n=>{let{addDoc:r,updateDoc:i,recordActivity:s}=g(n),l=document.getElementById(`m_product`).value,u=document.getElementById(`m_stockType`).value,f=document.getElementById(`m_adjustType`).value,p=D(),m=document.getElementById(`m_reason`).value.trim(),h=document.getElementById(`m_staff`).value;if(!l||!Number.isFinite(p)||p<=0||!m||!h){alert(`모든 필수 항목을 입력해주세요.`);return}let _=c();if(await d(_,n))return;let v=f===`plus`?p:-p,y=e.filter(e=>e.productName===l&&e.stockType===u).sort((e,t)=>e.date.localeCompare(t.date));if(y.length>0){let e=y[0],n=Number(e.remaining||0),r=T(n+v);if(r<-x){alert(`조정 후 잔량이 ${E(r)}개가 됩니다.\n수동조정으로 음수 재고를 만들 수 없습니다.\n현재 ${E(n)}개에서 최대 ${E(n)}개까지만 감소 가능합니다.`);return}await i(t(o,`frozenSeparation`,e.id),{remaining:r,closed:r<=x,updatedAt:new Date})}else{if(v<0){alert(`해당 제품/구분의 재고가 없습니다.
수동조정으로 음수 재고를 만들 수 없습니다.`);return}await r(a(o,`frozenSeparation`),{date:c(),productName:l,stockType:u,initialQty:v,remaining:v,staffName:h,note:m,closed:!1,createdAt:new Date,updatedAt:new Date})}if(await r(a(o,`frozenSeparationLogs`),{date:c(),timestamp:new Date,type:`adjust`,productName:l,fromStockType:u,qty:v,staffName:h,reason:m}),await s({action:`frozenSep`,subAction:`adjust`,date:_,staff:h,message:`동결 분리작업 수동조정 — ${l} (${k(u)}) ${v>=0?`+`:``}${E(v)}개 / 사유: ${m} / 담당: ${h}`,details:{productName:l,stockType:u,delta:v,reason:m}}),!n.isCurrent())return;closeModal();let[b,S]=await Promise.all([C(),w()]);n.isCurrent()&&(V(b,S),alert(`조정 완료!`))},{roles:[`admin`,`office`,`production`]}))}var Y={};function X(e){let t=``;for(let n of e)(Y[n]||[]).forEach(e=>{t+=`<option value="${e.name}">${e.name}</option>`});return t}function Z(e){let t=document.getElementById(`modalOverlay`);t&&t.remove();let n=document.createElement(`div`);n.id=`modalOverlay`,n.className=`modal-overlay`,n.innerHTML=`<div class="modal-box">${e}</div>`,document.body.appendChild(n),n.addEventListener(`click`,e=>{})}s(`frozenSep`,function(){let e=document.getElementById(`modalOverlay`);e&&e.remove()});var Q=p(`frozenSep`);Q.refresh=S;export{S as renderFrozenSep};