import{a as e,b as t,d as n,g as r,s as i,u as a,y as o}from"./index.esm-rHmxwfvm.js";import{n as s}from"./firebase-qGjqjNvO.js";import{n as c}from"./modalManager-Z4b2ihO9.js";import{I as l,W as u,b as d}from"./index-BvUufXtY.js";import"./activityLogs-CtU4U8Oc.js";import{t as f}from"./closingGuard-C7IU8dK_.js";import{t as p}from"./sortable-B9aQZmIg.js";import{t as m}from"./pageResources-DBecWn5C.js";import{t as h}from"./pageRefresh-D_VW7uvN.js";import"./meatLogs-BCGL3lOX.js";import{t as g}from"./pageCommand-DOC7oE71.js";import{t as _}from"./commandWrites-CkkiGB36.js";import{t as v}from"./pageStaff-CdJTpDb_.js";var y=[],b=[],x=`frozen`,S=null,C=[],w=null,T=new Set,E=new Set;async function D({force:e=!1}={}){let t=document.getElementById(`mainContent`);t.innerHTML=`<p style="padding:24px">원료 재고 로딩 중...</p>`,await Re({force:e}),d()?.isCurrent()&&xe()}async function O(t={getDocs:i,getDoc:e}){let r=n(o(s,`meatTypes`),a(`sortOrder`));return(await t.getDocs(r)).docs.map(e=>({id:e.id,...e.data()}))}function ee(e){return(Array.isArray(e)?e:[]).map((e,t)=>({id:String(e?.id||``).trim(),name:String(e?.name||``).trim(),sortOrder:Number.isFinite(Number(e?.sortOrder))?Number(e.sortOrder):t,scope:e?.scope===`produce`?`produce`:`meat`})).filter(e=>e.id&&e.name).sort((e,t)=>(e.sortOrder??0)-(t.sortOrder??0)||e.name.localeCompare(t.name,`ko`))}async function k(n={getDocs:i,getDoc:e}){let r=await n.getDoc(t(s,`settings`,`meatStockCategories`));return r.exists()?ee(r.data().groups):[]}async function A(e,n){if(!n)return g($,t=>A(e,t));let{setDoc:r}=_(n),i=ee(e).map((e,t)=>({...e,sortOrder:t}));await r(t(s,`settings`,`meatStockCategories`),{groups:i,updatedAt:new Date},{merge:!0}),b=i}function j(){return x===`produce`?`produce`:`meat`}function M(e=j()){return b.filter(t=>(t.scope||`meat`)===e)}function N(){return y.filter(e=>e.active!==!1)}function te(e){return y.find(t=>t.id===e)?.category||`meat`}function P(e){return te(e)===`produce`}function ne(e){return!P(e.meatTypeId)}function re(e){return P(e.meatTypeId)}function ie(e){return!P(e.meatTypeId)}function ae(e){return P(e.meatTypeId)}async function oe(t,c={getDocs:i,getDoc:e}){let l=n(o(s,`meatLogs`),r(`stage`,`==`,t),a(`timestamp`,`desc`));return(await c.getDocs(l)).docs.map(e=>({id:e.id,...e.data()}))}function F(e){return{frozenIncoming:`입고`,frozenOut:`전처리로 출고`,processedIn:`전처리`,processedOut:`재포장으로 출고`,repackedIn:`재포장`,repackedOut:`출고`,productionDeduct:`생산차감`,productionRollback:`생산복원`,adjust:`수동조정`}[e]||e}function I(e){if(!e)return`-`;let t=e.toDate?e.toDate():new Date(e);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)} ${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}`}function L(e){return typeof e==`number`?`${e>0?`+`:``}${(e/1e3).toFixed(2)}kg`:`-`}async function R(t,r={getDocs:i,getDoc:e}){let c=n(o(s,`meatStocks`),a(`incomingDate`));return(await r.getDocs(c)).docs.map(e=>({id:e.id,...e.data()})).filter(e=>e.stage===t&&!e.closed)}function z(e,t){let n=y.find(e=>e.id===t)?.minimumQtyG||0;return n<=0?`#1a1a1a`:e<n?`#e53e3e`:e<n*1.5?`#dd6b20`:`#1a1a1a`}function B(e){let t=new Map;return(e||[]).forEach(e=>{let n=e.meatTypeId||e.meatNameSnapshot||e.id,r=t.get(n);r?(r.totalG+=Number(e.remaining||0),r.lots.push(e)):t.set(n,{name:e.meatNameSnapshot||`원료`,totalG:Number(e.remaining||0),meatTypeId:e.meatTypeId,lots:[e]})}),t}function V(e=``){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function se(){return`cat_${Date.now()}_${Math.random().toString(36).slice(2,8)}`}function ce(e){return y.find(t=>t.id===e)?.groupId||null}function H(e){let t=y.find(t=>t.id===e)?.groupSortOrder;return Number.isFinite(Number(t))?Number(t):2**53-1}function le(e){let t=M().map(e=>({...e,items:[],virtual:!1})),n=new Map(t.map(e=>[e.id,e])),r={id:`__other__`,name:`기타`,sortOrder:2**53-1,items:[],virtual:!0};return[...e.values()].forEach(e=>{let t=e.meatTypeId?ce(e.meatTypeId):null;(t&&n.has(t)?n.get(t):r).items.push(e)}),[...t,r].forEach(e=>{e.items.sort((e,t)=>{let n=H(e.meatTypeId),r=H(t.meatTypeId);return n===r?(e.name||``).localeCompare(t.name||``,`ko`):n-r})}),r.items.length>0?[...t,r]:t}function ue(e){let t=z(e.totalG,e.meatTypeId),n=u===`admin`||u===`office`,r=e.meatTypeId||e.name,i=!T.has(r),a=[...e.lots||[]].sort((e,t)=>{let n=String(e.incomingDate||e.processedDate||e.repackedDate||``),r=String(t.incomingDate||t.processedDate||t.repackedDate||``);return n.localeCompare(r)});return`
  ...
  `}function U(e){let t=le(B(e)),n=u===`admin`||u===`office`;return`
  ...
  `,document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{x=e.dataset.tab,document.querySelectorAll(`.tab-btn`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),q(x)})}),q(x)}async function q(e){let t=document.getElementById(`tabContent`);t.innerHTML=`<div style="padding:24px;"><p>로딩 중...</p></div>`;let n=await Re();if(!n)return;let{stocks:r,logs:i}=n;!t.isConnected||e!==x||(e===`frozen`?Se(r,i):e===`processed`?we(r,i):e===`produce`?Ce(r,i):Te(r,i),be(),ge())}function Se(e,t){let n=document.getElementById(`tabContent`),r=u===`admin`||u===`office`,i=e.filter(ne),a=t.filter(ie),o=B(i);n.innerHTML=`
  ...
  `,document.getElementById(`btnAddFrozen`).addEventListener(`click`,()=>Ee()),document.getElementById(`btnMeatTypes`)?.addEventListener(`click`,()=>{if(u!==`admin`&&u!==`office`){alert(`원육 종류 관리는 대표/사무실 계정만 가능합니다.`);return}X()}),document.querySelectorAll(`.btn-adjust`).forEach(e=>{e.addEventListener(`click`,()=>J(e.dataset.id,e.dataset.name,parseFloat(e.dataset.remaining)))})}function Ce(e,t){let n=document.getElementById(`tabContent`),r=u===`admin`||u===`office`,i=e.filter(re),a=t.filter(ae),o=B(i);n.innerHTML=`
    <div style="display:flex;gap:8px;margin-bottom:16px;">
  ...
  `),document.getElementById(`btnSaveFrozen`).addEventListener(`click`,async()=>g($,async e=>{let{addDoc:t,recordActivity:n,recordMeatLog:a}=_(e),c=document.getElementById(`m_meatType`).value,l=document.getElementById(`m_meatType`),u=l.options[l.selectedIndex]?.text,d=parseFloat(document.getElementById(`m_weight`).value),p=document.getElementById(`m_unit`).value,m=document.getElementById(`m_date`).value,h=document.getElementById(`m_staff`).value,g=document.getElementById(`m_note`).value;if(!c||!d||!m){alert(`${i} 종류, 중량, 날짜는 필수입니다.`);return}if(!(d>0)){alert(`중량은 0보다 커야 합니다.`);return}if(!h){alert(`담당자를 선택해주세요.`);return}if(await f(m,e))return;let v=p===`kg`?d*1e3:d,y=await t(o(s,`meatStocks`),{meatTypeId:c,meatNameSnapshot:u,stage:`frozen`,incomingDate:m,initialQtyG:v,remaining:v,staffName:h,note:g,closed:!1,createdAt:new Date,updatedAt:new Date});await a({type:`frozenIncoming`,date:m,meatTypeId:c,meatNameSnapshot:u,stage:`frozen`,meatStockId:y.id,delta:v,before:0,after:v,staff:h,reason:g||null}),await n({action:`meat`,subAction:`incoming`,date:m,staff:h,message:`${i} 입고 (냉동창고) - ${u} +${(v/1e3).toFixed(1)}kg / 담당: ${h}`,details:{meatStockId:y.id,meatTypeId:c,meatName:u,stage:`frozen`,qtyG:v,note:g||null}}),e.isCurrent()&&(closeModal(),e.isCurrent()&&(q(r),alert(`입고 등록 완료!`)))},{roles:[`admin`,`office`,`production`]}))}function De(){Q(`
  ...
  `),document.getElementById(`m_meatType`).addEventListener(`change`,e=>{let t=e.target.options[e.target.selectedIndex].dataset.weight;t&&(document.getElementById(`m_unitWeight`).value=t)}),document.getElementById(`btnSaveProcessed`).addEventListener(`click`,async()=>g($,async e=>{let{addDoc:n,updateDoc:r,recordMeatLog:i}=_(e),a=document.getElementById(`m_meatType`).value,c=document.getElementById(`m_meatType`),l=c.options[c.selectedIndex]?.text,u=parseFloat(document.getElementById(`m_unitWeight`).value),d=parseInt(document.getElementById(`m_count`).value),p=document.getElementById(`m_date`).value,m=document.getElementById(`m_staff`).value,h=document.getElementById(`m_note`).value;if(!a||!u||!d||!p){alert(`원육 종류, 개당 중량, 개수, 날짜는 필수입니다.`);return}if(!(u>0)||!(d>0)){alert(`개당 중량과 개수는 0보다 커야 합니다.`);return}if(!m){alert(`담당자를 선택해주세요.`);return}if(await f(p,e))return;let g=u*d,v=(await R(`frozen`)).filter(e=>e.meatTypeId===a&&e.remaining>0).sort((e,t)=>(e.incomingDate||``).localeCompare(t.incomingDate||``)),y=v.reduce((e,t)=>e+t.remaining,0);if(y<g){alert(`냉동창고 잔량이 부족합니다.\n${l}: 필요 ${(g/1e3).toFixed(1)}kg / 현재 ${(y/1e3).toFixed(1)}kg`);return}let b=Date.now().toString(),x=Pe(),S=g;for(let e of v){if(S<=0)break;let n=Math.min(e.remaining,S),o=e.remaining-n;await r(t(s,`meatStocks`,e.id),{remaining:o,closed:o===0,updatedAt:new Date}),await i({type:`frozenOut`,date:p,meatTypeId:a,meatNameSnapshot:l,stage:`frozen`,meatStockId:e.id,delta:-n,before:e.remaining,after:o,staff:m,reason:`전처리 등록 자동차감`,batchId:b}),S-=n}await i({type:`processedIn`,date:p,meatTypeId:a,meatNameSnapshot:l,stage:`processed`,meatStockId:(await n(o(s,`meatStocks`),{meatTypeId:a,meatNameSnapshot:l,stage:`processed`,incomingDate:p,processedDate:p,unitWeightG:u,unitCount:d,initialQtyG:g,remaining:g,batchId:b,batchColor:x,staffName:m,note:h,closed:!1,createdAt:new Date,updatedAt:new Date})).id,delta:g,before:0,after:g,staff:m,reason:h||null,batchId:b}),e.isCurrent()&&(closeModal(),e.isCurrent()&&(q(`processed`),alert(`전처리 등록 완료!`)))},{roles:[`admin`,`office`,`production`]}))}function Oe(){Q(`
  ...
  `),document.getElementById(`m_meatType`).addEventListener(`change`,e=>{let t=e.target.options[e.target.selectedIndex].dataset.weight;t&&(document.getElementById(`m_unitWeight`).value=t)}),document.getElementById(`btnSaveRepacked`).addEventListener(`click`,async()=>g($,async e=>{let{addDoc:n,updateDoc:r,recordMeatLog:i}=_(e),a=document.getElementById(`m_meatType`).value,c=document.getElementById(`m_meatType`),l=c.options[c.selectedIndex]?.text,u=parseFloat(document.getElementById(`m_unitWeight`).value),d=parseInt(document.getElementById(`m_count`).value),p=document.getElementById(`m_date`).value,m=document.getElementById(`m_staff`).value,h=document.getElementById(`m_note`).value;if(!a||!u||!d||!p){alert(`원육 종류, 개당 중량, 개수, 날짜는 필수입니다.`);return}if(!(u>0)||!(d>0)){alert(`개당 중량과 개수는 0보다 커야 합니다.`);return}if(!m){alert(`담당자를 선택해주세요.`);return}if(await f(p,e))return;let g=u*d,v=(await R(`repacked`)).find(e=>e.meatTypeId===a&&e.remaining>0);if(v){alert(`같은 원육의 재포장 행이 이미 존재합니다.\n${l}: 기존 잔량 ${(v.remaining/1e3).toFixed(1)}kg\n기존 재포장을 모두 사용한 후 등록하세요.`);return}let y=(await R(`processed`)).filter(e=>e.meatTypeId===a&&e.remaining>0).sort((e,t)=>(e.processedDate||``).localeCompare(t.processedDate||``)),b=y.reduce((e,t)=>e+t.remaining,0);if(b<g){alert(`전처리 잔량이 부족합니다.\n${l}: 필요 ${(g/1e3).toFixed(1)}kg / 현재 ${(b/1e3).toFixed(1)}kg`);return}let x=Date.now().toString(),S=Pe(),C=g;for(let e of y){if(C<=0)break;let n=Math.min(e.remaining,C),o=e.remaining-n;await r(t(s,`meatStocks`,e.id),{remaining:o,closed:o===0,updatedAt:new Date}),await i({type:`processedOut`,date:p,meatTypeId:a,meatNameSnapshot:l,stage:`processed`,meatStockId:e.id,delta:-n,before:e.remaining,after:o,staff:m,reason:`재포장 등록 자동차감`,batchId:x}),C-=n}await i({type:`repackedIn`,date:p,meatTypeId:a,meatNameSnapshot:l,stage:`repacked`,meatStockId:(await n(o(s,`meatStocks`),{meatTypeId:a,meatNameSnapshot:l,stage:`repacked`,incomingDate:p,repackedDate:p,unitWeightG:u,unitCount:d,initialQtyG:g,remaining:g,batchId:x,batchColor:S,staffName:m,note:h,closed:!1,createdAt:new Date,updatedAt:new Date})).id,delta:g,before:0,after:g,staff:m,reason:h||null,batchId:x}),e.isCurrent()&&(closeModal(),e.isCurrent()&&(q(`repacked`),alert(`재포장 등록 완료!`)))},{roles:[`admin`,`office`,`production`]}))}function J(e,n,r){Q(`
  ...
  `),document.getElementById(`btnSaveAdjust`).addEventListener(`click`,async()=>g($,async i=>{let{getDoc:a,updateDoc:o,recordActivity:c,recordMeatLog:u}=_(i),d=document.getElementById(`m_actualRemaining`).value,p=document.getElementById(`m_adjustReason`).value.trim(),m=document.getElementById(`m_staff`).value;if(d===``||isNaN(parseFloat(d))){alert(`실제 잔량을 입력해주세요.`);return}let h=parseFloat(d);if(h<0){alert(`실제 잔량은 0 이상이어야 합니다.
잔량이 음수가 될 수 없습니다.`);return}if(!p||!m){alert(`사유와 담당자는 필수입니다.`);return}let g=h-r;if(g===0){alert(`기존 잔량과 동일합니다. 변경할 값을 입력해주세요.`);return}let v=l();if(await f(v,i))return;let y=await a(t(s,`meatStocks`,e)),b=(y.exists()?y.data():{}).meatTypeId||null;await o(t(s,`meatStocks`,e),{remaining:h,closed:h===0,updatedAt:new Date});let S=x===`produce`?`frozen`:x,C=x===`frozen`?`냉동창고`:x===`processed`?`전처리`:x===`produce`?`채소/과일`:`재포장`;await c({action:`meat`,subAction:`adjust`,date:v,staff:m,message:`원육 수동조정 (${C}) — ${n} ${(r/1e3).toFixed(1)}kg → ${(h/1e3).toFixed(1)}kg / 사유: ${p} / 담당: ${m}`,details:{meatStockId:e,meatName:n,stage:C,delta:g,before:r,after:h,reason:p}}),await u({type:`adjust`,date:v,meatTypeId:b,meatNameSnapshot:n,stage:S,meatStockId:e,delta:g,before:r,after:h,staff:m,reason:p}),i.isCurrent()&&(closeModal(),i.isCurrent()&&(q(x),alert(`조정 완료!`)))},{roles:[`admin`,`office`,`production`]}))}function ke(){let e=M();return e.length===0?`<tr><td colspan="4" style="text-align:center;color:#aaa;padding:16px;">등록된 카테고리 없음</td></tr>`:e.map(e=>{let t=y.filter(t=>t.groupId===e.id).length;return`
      <tr data-id="${e.id}">
    ...
    `}).join(``)}async function Ae(){y=await O(),b=await k(),await q(x),Y()}function Y(){if(u!==`admin`&&u!==`office`){alert(`카테고리 관리는 대표/사무실 계정만 가능합니다.`);return}Q(`
  ...
  `),je(),document.querySelectorAll(`.m-unit-weight`).forEach(e=>{e.addEventListener(`change`,async e=>g($,async n=>{let{updateDoc:r}=_(n),i=e.target.dataset.id,a=y.find(e=>e.id===i),o=a?.defaultUnitWeightG,c=parseFloat(e.target.value);if(!isFinite(c)||c<=0){alert(`기본 단위중량은 양수(g)여야 합니다.`),e.target.value=o??``;return}try{await r(t(s,`meatTypes`,i),{defaultUnitWeightG:c,updatedAt:new Date}),a&&(a.defaultUnitWeightG=c)}catch(t){console.error(`[meat] defaultUnitWeightG 저장 실패:`,t),alert(`저장 실패: `+(t.message||t)),e.target.value=o??``}},{roles:[`admin`,`office`]}))}),document.querySelectorAll(`.m-min-qty`).forEach(e=>{e.addEventListener(`change`,async e=>g($,async n=>{let{updateDoc:r}=_(n),i=e.target.dataset.id,a=y.find(e=>e.id===i),o=a?.minimumQtyG??0,l=parseFloat(e.target.value);if(!isFinite(l)||l<0){alert(`최소재고는 0 이상(${p})이어야 합니다.`),e.target.value=c?o:(o/1e3).toFixed(1);return}let u=Math.round(c?l:l*1e3);try{await r(t(s,`meatTypes`,i),{minimumQtyG:u,updatedAt:new Date}),a&&(a.minimumQtyG=u)}catch(t){console.error(`[meat] minimumQtyG 저장 실패:`,t),alert(`저장 실패: `+(t.message||t)),e.target.value=c?o:(o/1e3).toFixed(1)}},{roles:[`admin`,`office`]}))}),document.querySelectorAll(`.m-active-toggle`).forEach(n=>{n.addEventListener(`change`,async n=>g($,async r=>{let{updateDoc:i,recordActivity:a}=_(r),o=n.target.dataset.id,c=n.target.checked,u=y.find(e=>e.id===o),d=u?.active!==!1;try{if(await i(t(s,`meatTypes`,o),{active:c,updatedAt:new Date}),u&&(u.active=c),d!==c&&await a({action:`meat`,subAction:`activeToggle`,date:l(),staff:Ie(),message:`Meat type ${c?`active`:`inactive`} — ${u?.name||o}`,details:{meatTypeId:o,meatName:u?.name||``,active:c}}),!r.isCurrent()||(closeModal(),!r.isCurrent()))return;X(e)}catch(e){console.error(`[meat] active save failed:`,e),alert(`Save failed: `+(e.message||e)),n.target.checked=!c}},{roles:[`admin`,`office`]}))}),document.getElementById(`btnAddMeatType`).addEventListener(`click`,async()=>g($,async t=>{let{addDoc:n}=_(t),i=document.getElementById(`m_newMeatName`).value.trim(),a=parseFloat(document.getElementById(`m_newUnitWeight`).value)||0,l=parseFloat(document.getElementById(`m_newMinQty`).value)||0,u=r;if(!i){alert(`${d}명은 필수입니다.`);return}await n(o(s,`meatTypes`),{name:i,defaultUnitWeightG:a,minimumQtyG:Math.round(c?l:l*1e3),category:u,sortOrder:y.length,active:!0,showInStats:!0,createdAt:new Date,updatedAt:new Date}),y=await O(),t.isCurrent()&&(closeModal(),t.isCurrent()&&X(e))},{roles:[`admin`,`office`]}))}function je(){if(Me(),u!==`admin`&&u!==`office`)return;let e=document.getElementById(`meatTypesList`);e&&(S=p.create(e,{handle:`.drag-handle`,animation:150,ghostClass:`sortable-ghost`,chosenClass:`sortable-chosen`,onEnd:async e=>{e.oldIndex!==e.newIndex&&await Ne()}}))}function Me(){if(S){try{S.destroy()}catch(e){console.warn(`[meat] sortable destroy skipped:`,e)}S=null}}async function Ne(){return g($,async e=>{let{writeBatch:n}=_(e),r=document.getElementById(`meatTypesList`);if(!r)return;let i=Array.from(r.querySelectorAll(`tr[data-id]`)).map(e=>e.dataset.id).filter(Boolean),a=new Date,o=n(s);i.forEach((e,n)=>{o.update(t(s,`meatTypes`,e),{sortOrder:n,updatedAt:a})});try{await o.commit();let e=new Map(i.map((e,t)=>[e,t]));y=y.map(t=>e.has(t.id)?{...t,sortOrder:e.get(t.id),updatedAt:a}:t).sort((e,t)=>(e.sortOrder??0)-(t.sortOrder??0))}catch(t){if(console.error(`[meat] reorder save failed:`,t),alert(`순번 저장 실패: `+(t.message||t)),y=await O(),!e.isCurrent()||(closeModal(),!e.isCurrent()))return;X()}},{roles:[`admin`,`office`]})}function Pe(){let e=[`#e8f4ea`,`#e8eef8`,`#fef0e8`,`#f0e8fe`,`#fff0e8`,`#e8f8f4`];return e[Math.floor(Math.random()*e.length)]}var Fe={};function Ie(){return u===`admin`?`대표`:u===`office`?`사무실`:u===`production`?`생산실`:`시스템`}function Z(e){let t=``;for(let n of e)(Fe[n]||[]).forEach(e=>{t+=`<option value="${e.name}">${e.name}</option>`});return t}function Q(e){let t=document.getElementById(`modalOverlay`);t&&t.remove();let n=document.createElement(`div`);n.id=`modalOverlay`,n.className=`modal-overlay`,n.innerHTML=`<div class="modal-box">${e}</div>`,document.body.appendChild(n),n.addEventListener(`click`,e=>{})}c(`meat`,function(){Me();let e=document.getElementById(`modalOverlay`);e&&e.remove()});var $=m(`meat`);$.refresh=D;var Le=null;async function Re({force:e=!1}={}){let t=x===`produce`?`frozen`:x;t!==Le&&(Le=t,e=!0);let n=await $.load(async e=>{let[n,r,i,a,o]=await Promise.all([O(e),k(e),v(e),R(t,e),oe(t,e)]);return{types:n,categories:r,staff:i,stocks:a,logs:o}},{force:e,onChange:h($,D)});return n&&(y=n.types,b=n.categories,Fe=n.staff),n}export{D as renderMeat};