import{c as e,d as t,f as n,g as r,i,o as a,u as o,v as s,w as c,y as l}from"./index.esm-ESivpAya.js";import{n as u}from"./firebase-I0rBIq9V.js";import{n as d}from"./modalManager-Z4b2ihO9.js";import{B as f,M as p,v as m,z as ee}from"./index-BMnUILA5.js";import{i as h,o as te}from"./menuStaffGroups-C31mo2ya.js";var ne=14,g=10,_=5,v=[],y=[],b=[],x=`all`,S={},C=null,w=``,T=``,E=``;async function D(){let e=document.getElementById(`mainContent`);e.innerHTML=`<div style="padding:24px;"><p>영양제 재고 로딩 중...</p></div>`,await Promise.all([O(),X(),re()]),await ve(),e.isConnected&&k()}async function re(){let e=document.getElementById(`mainContent`),t=await te();document.getElementById(`mainContent`)===e&&(g=Number(t.supplementThresholdYellow)||10,_=Number(t.supplementThresholdRed)||5)}async function O(){let e=document.getElementById(`mainContent`),n=ie(),i=n[n.length-1],[c,l,d]=await Promise.all([a(t(s(u,`supplementTypes`),o(`sortOrder`))),a(s(u,`supplementStock`)),a(t(s(u,`supplementLogs`),r(`date`,`>=`,i)))]);document.getElementById(`mainContent`)===e&&(v=c.docs.map(e=>({id:e.id,...e.data()})),y=l.docs.map(e=>({id:e.id,...e.data()})),b=d.docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>{if(e.date!==t.date)return e.date<t.date?1:-1;let n=e.timestamp?.seconds||0;return(t.timestamp?.seconds||0)-n}))}function ie(){let e=p(),t=new Date(`${e}T00:00:00`),n=[];for(let e=0;e<ne;e++){let r=new Date(t);r.setDate(t.getDate()-e);let i=r.getFullYear(),a=String(r.getMonth()+1).padStart(2,`0`),o=String(r.getDate()).padStart(2,`0`);n.push(`${i}-${a}-${o}`)}return n}function k(){let e=document.getElementById(`mainContent`);e.innerHTML=`
