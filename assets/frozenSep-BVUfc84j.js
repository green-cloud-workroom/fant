import{a as e,b as t,d as n,s as r,u as i,y as a}from"./index.esm-rHmxwfvm.js";import{n as o}from"./firebase-qGjqjNvO.js";import{n as s}from"./modalManager-Z4b2ihO9.js";import{G as c,L as l,h as u}from"./index-DRMzawyA.js";import"./activityLogs-DYC0UZD3.js";import{t as d}from"./closingGuard-Dfuw_srM.js";import{t as f}from"./sortable-Du2optuH.js";import{t as p}from"./pageResources-BE3e2wtt.js";import{t as m}from"./pageRefresh-D3ZSodaR.js";import{t as h}from"./pageCommand-BkcRKfco.js";import{t as g}from"./commandWrites-DtPED3QM.js";import{n as _,t as v}from"./recipe-LxfTZLbF.js";import{t as y}from"./pageStaff-Cns9055z.js";var b=[],x=1e-6;async function S({force:e=!1}={}){let n=document.getElementById(`mainContent`);n.innerHTML=`<p style="padding:24px">동결 분리작업 로딩 중...</p>`;let r=await Q.load(async e=>{let[n,r,i,a,s]=await Promise.all([v(e),C(e),w(e),y(e),e.getDoc(t(o,`settings`,`frozenSepProductOrder`))]);return{recipes:n,stocks:r,logs:i,staff:a,order:s.exists()&&s.data().order||[]}},{force:e,onChange:m(Q,S)});!r||!n.isConnected||(b=r.recipes,Y=r.staff,R=r.order,V(r.stocks,r.logs))}async function C(t={getDocs:r,getDoc:e}){let s=n(a(o,`frozenSeparation`),i(`date`,`desc`));return(await t.getDocs(s)).docs.map(e=>({id:e.id,...e.data()})).filter(e=>!e.closed)}async function w(t={getDocs:r,getDoc:e}){let s=n(a(o,`frozenSeparationLogs`),i(`timestamp`,`desc`));return(await t.getDocs(s)).docs.map(e=>({id:e.id,...e.data()}))}function T(e){return Math.round((Number(e)||0)*1e6)/1e6}function E(e){return T(e).toLocaleString(`ko-KR`,{maximumFractionDigits:3})}function D(e=`m_qty`){let t=Number(document.getElementById(e).value);return Number.isFinite(t)?t:NaN}function O(){return c===`admin`||c===`office`}function k(e){return e===`notSeparated`?`분리X`:e===`separated`?`분리O`:`소분X`}function A(e){return e===`notSeparated`?`tag-cat`:e===`separated`?`tag-raw`:`tag-freezeDry`}function j(e){let t=Number(e.qty||0);switch(e.type){case`incoming`:return[{stockType:e.toStockType,delta:t}];case`separate`:return[{stockType:e.fromStockType,delta:-t},{stockType:e.toStockType,delta:t}];case`out`:return[{stockType:e.fromStockType,delta:-t}];case`adjust`:return[{stockType:e.fromStockType,delta:t}];case`delete`:return[{stockType:e.fromStockType,delta:t}];default:return[]}}function M(e,t){let n={};e.forEach(e=>{let t=`${e.productName}|${e.stockType}`;n[t]=T((n[t]||0)+Number(e.remaining||0))});let r={};for(let e of t){let t=j(e),i={};t.forEach(t=>{if(!t.stockType)return;let r=`${e.productName}|${t.stockType}`;i[t.stockType]=T(n[r]||0),n[r]=T((n[r]||0)-t.delta)}),r[e.id]=i}return r}function N(e){return{incoming:`입고`,separate:`분리`,out:`출고`,adjust:`조정`,delete:`삭제`}[e]||e}function P(e){return{incoming:`#2d7a3a`,separate:`#1f6fb2`,out:`#b97a1f`,adjust:`#8a5fbf`,delete:`#e53e3e`}[e]||`#555`}var F={notSeparated:{bar:`#EF9F27`,bg:`#fdf3e0`,text:`#b97a1f`},separated:{bar:`#1D9E75`,bg:`#e8f5ea`,text:`#2d7a3a`},noSplit:{bar:`#378ADD`,bg:`#e8f0fc`,text:`#2d4a8a`}},I=new Set,L=`daily`,R=[];function z(e){return[...e].sort((e,t)=>{let n=R.indexOf(e),r=R.indexOf(t);return n!==-1&&r!==-1?n-r:n===-1?r===-1?e.localeCompare(t,`ko`):1:-1})}function B(e,t){let n={};e.forEach(e=>{let t=`${e.productName}|${e.stockType}`;n[t]=T((n[t]||0)+Number(e.remaining||0))});let r=[...new Set(t.map(e=>e.date).filter(Boolean))].sort().reverse(),i=l(),a=r.includes(i)?r:[i,...r.filter(e=>e<i)],o=[...t].filter(e=>e.date).sort((e,t)=>t.date.localeCompare(e.date)),s=0,c={},u={};for(let e of a){for(;s<o.length&&o[s].date>e;){let e=o[s];j(e).forEach(t=>{if(!t.stockType)return;let r=`${e.productName}|${t.stockType}`;n[r]=T((n[r]||0)-t.delta)}),s++}c[e]={...n},u[e]=[...new Set(t.filter(t=>t.date===e).map(e=>e.staffName).filter(Boolean))].join(`, `)}return{dates:a,snapshots:c,staffByDate:u}}function V(e,n=[]){let r=document.getElementById(`mainContent`),i=O(),a=M(e,n),s=z([...new Set([...e.map(e=>e.productName),...n.map(e=>e.productName).filter(Boolean)])]);r.innerHTML=`
  ...
  `}async function W(e){return h(Q,async n=>{let{writeBatch:r,recordActivity:i}=g(n);if(!O()){alert(`삭제 권한이 없습니다.`);return}if(await d(e.date,n))return;let s=Number(e.initialQty||0),c=Number(e.remaining||0);if(c<=0){alert(`삭제할 남은 수량이 없습니다.`);return}if(Math.abs(s-c)>x){alert(`이미 일부 사용된 항목은 바로 삭제할 수 없습니다.
관련 출고/분리 작업을 먼저 되돌리거나 수동 조정을 사용해주세요.`);return}let f=window.prompt(`삭제 담당자 이름을 입력해주세요.`);if(!f||!f.trim())return;let p=k(e.stockType);if(!await u({title:`동결 분리작업 삭제`,message:`${e.productName} / ${p} / ${E(c)}개 항목을 삭제합니다.\n잘못 입력한 항목일 때만 진행해주세요.`,confirmText:`삭제`,cancelText:`취소`,danger:!0}))return;let m=r(o),h=t(o,`frozenSeparation`,e.id),_=t(a(o,`frozenSeparationLogs`)),v=new Date,y=f.trim();m.update(h,{remaining:0,closed:!0,status:`deleted`,deletedAt:v,deletedBy:y,updatedAt:v}),m.set(_,{date:l(),timestamp:v,type:`delete`,productName:e.productName,fromStockType:e.stockType,qty:-c,staffName:y,note:`wrong input delete`,sourceStockId:e.id}),await m.commit(),await i({action:`frozenSep`,subAction:`delete`,date:l(),staff:y,message:`동결 분리작업 삭제 — ${e.productName} ${E(c)}개 (${p}) / 담당: ${y}`,details:{frozenSeparationId:e.id,productName:e.productName,qty:c,stockType:e.stockType,note:e.note||null}});let[b,S]=await Promise.all([C(),w()]);n.isCurrent()&&(V(b,S),alert(`삭제 완료!`))},{roles:[`admin`,`office`]})}function G(e){Z(`
